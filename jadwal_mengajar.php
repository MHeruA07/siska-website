                           ...
                           <div class="card-body card-block">
                               ...
                               <div class="table-responsive">
                                  <table class="table middle-text thick-text">
                                      ...
                                      <tbody>
                                          <tr>
                                              <td class="right-border" style="width: 20%;">1 Multimedia 2</td>
                                              <td class="right-border" style="width: 20%;">07:00 - 08:30</td>
                                              <td>Keterampilan Komputer & Pengenalan Interaksi (KKPI)</td>
                                          </tr>
                                          <tr>
                                              <td class="right-border" style="width: 20%;">2 Multimedia 4</td>
                                              <td class="right-border" style="width: 20%;">10:00 - 11:30</td>
                                              <td>Animasi</td>
                                          </tr>
                                      </tbody>
                                  </table>
                                ...
                                <div class="table-responsive">
                                   <table class="table middle-text thick-text">
                                       ...
                                       <tbody>
                                         <tr>
                                           <td class="right-border" style="width: 20%;">1 Multimedia 1</td>
                                           <td class="right-border" style="width: 20%;">08:30 - 10:00</td>
                                           <td>Keterampilan Komputer & Pengenalan Interaksi (KKPI)</td>
                                         </tr>
                                       </tbody>
                                   </table>
                                 ...
                                 <div class="table-responsive">
                                    <table class="table middle-text thick-text">
                                        ...
                                        <tbody>
                                          <tr>
                                            <td class="right-border" style="width: 20%;">1 Multimedia 4</td>
                                            <td class="right-border" style="width: 20%;">07:00 - 08:30</td>
                                            <td>Keterampilan Komputer & Pengenalan Interaksi (KKPI)</td>
                                          </tr>
                                          <tr>
                                            <td class="right-border" style="width: 20%;">1 Multimedia 3</td>
                                            <td class="right-border" style="width: 20%;">08:30 - 10:00</td>
                                            <td>Keterampilan Komputer & Pengenalan Interaksi (KKPI)</td>
                                          </tr>
                                        </tbody>
                                  ...
                                  <div class="table-responsive">
                                     <table class="table middle-text thick-text">
                                         ...
                                         <tbody>
                                           <tr>
                                             <td class="right-border" style="width: 20%;">2 Multimedia 3</td>
                                             <td class="right-border" style="width: 20%;">12:00 - 13:30</td>
                                             <td>Animasi</td>
                                           </tr>
                                         </tbody>
                                     </table>
                                  ...
                                  <div class="table-responsive">
                                     <table class="table middle-text thick-text">
                                         ...
                                         <tbody>
                                           <tr>
                                             <td class="right-border" style="width: 20%;">2 Multimedia 1</td>
                                             <td class="right-border" style="width: 20%;">12:00 - 13:30</td>
                                             <td>Animasi</td>
                                           </tr>
                                         </tbody>
