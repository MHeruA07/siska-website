                   ...
                   <div class="col-lg-12">
                       <div class="card card-outline-warning">
                           <div class="card-header">
                               <h4 class="m-b-0 text-white">Data Absensi Siswa</h4>
                           </div>
                                      ...
                                      <tbody>
                                          <tr>
                                              ...
                                              <td class="centerize-from-col">
                                                <input type="radio" name="absensi" value="hadir" class="form-check-input">
                                              </td>
                                              <td class="centerize-from-col">
                                                <input type="radio" name="absensi" value="ijin" class="form-check-input">
                                              </td>
                                              <td class="centerize-from-col">
                                                <input type="radio" name="absensi" value="alpha" class="form-check-input">
                                              </td>
                                              <td></td>
                                          </tr>
                                      </tbody>
